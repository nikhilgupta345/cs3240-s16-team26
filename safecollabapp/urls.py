...
urlpatterns = [
    ...
    url(r'^view_file/$', views.view_file, name='View File'),
    url(r'^delete_report/$', views.delete_report, name='Delete Report'),
    url(r'^delete_file/$', views.delete_file, name='Delete File'),
    ...
    url(r'^edit_folder/$', views.edit_folder, name='Edit Folder'),
