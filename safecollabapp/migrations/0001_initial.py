# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-05-02 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=b'name', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='safecollabapp.Folder')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encrypted', models.BooleanField(default=False)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='safecollabapp.Report')),
            ],
        ),
        migrations.CreateModel(
            name='SafeCollabUser',
